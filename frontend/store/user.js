...
export const actions = {
  ...
  downloadReport({ commit, state }, category) {
    const endpoint = process.env.apiEndpoint;
    const api =
      endpoint + `/${category === "investor" ? "investor" : "detail"}-report`;
    const fileName =
      category === "investor" ? "Investor Report.xlsx" : "Detail Report.xlsx";
    if (category === "investor") commit("setLoadingInvestorReport", true);
    else commit("setLoadingDetailReport", true);
    ...
    axios
      ...
      .then(response => {
        ...
        if (category === "investor") commit("setLoadingInvestorReport", false);
        else commit("setLoadingDetailReport", false);
      });
  },
